...
export class WarehouseService {
    ...
    /**
     * Fulfill demand using grosir bundle composition
     * Simplified model - checks actual warehouse inventory
     */
    async fulfillBundleDemand(data: FulfillBundleDemandDTO) {
        ...
        console.log(`Bundle composition: ${unitsPerBundle} units/bundle`);
        ...
        if (availableStock >= quantity) {
            console.log(`Sufficient stock: ${availableStock} available, need ${quantity}`);
        ...
        // 4. Insufficient stock - calculate bundles needed and create purchase order
        ...
        console.log(`Insufficient stock. Need ${bundlesToOrder} bundles (${unitsToOrder} units)`);
     ...
     * Used by group-buying-service to check availability
     */
